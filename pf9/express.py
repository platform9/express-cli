...
def cli(ctx):
    ...
    ctx.obj['pf9_ansible_cfg'] = os.path.join(ctx.obj['pf9_exp_dir'], 'express/ansible.cfg')
    ctx.obj['pf9_k8_playbook'] = os.path.join(ctx.obj['pf9_exp_dir'], 'express/pf9-k8s-express.yml')
